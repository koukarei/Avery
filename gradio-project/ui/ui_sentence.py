...
with gr.Blocks() as avery_gradio:
    ...
    gr.Markdown(
    """
    # 各写真を注意深く観察し、その写真に写っている人々、動物、または物について英語で1文を書いてください。回答は次の質問に焦点を当ててください：「写真には何が写っているのか」「それらは何をしているのか」「それらはどのように見えるのか（数や色など）」「それらはどこにいるのか」。写真に人が写っている場合、その外見についても説明する必要があります。
    """
    )
